...
})(
  {
    ...
    3: [
      function (t, e, i) {
        function n(t, e) {
          window.matchMedia &&
            ...
            s(this.opts.mediaQueryDefinitions) &&
              ((this.opts.mediaQueryDefinitions = l(
        ...
        function r(t) {
          return c[t] ? c[t] : ((c[t] = window.matchMedia(t)), c[t]);
        }
        var a = t("debounce"),
      ...
      function (t, e, i) {
        ...
        (n.prototype.handleFormSubmits = function (t) {
          ...
          (n.prototype.shouldTrackOutboundForm = function (t) {
            ...
            return (
              e && 0 === e.indexOf("http") && e.indexOf(location.hostname) < 0
            );
          }),
          (n.prototype.remove = function () {
            this.delegate.destroy(),
      ...
      function (t, e, i) {
        function n(t, e) {
          if (window.addEventListener) {
            ...
            (this.handleSocialClicks = this.handleSocialClicks.bind(this)),
              ...
              (this.addTwitterEventHandlers = this.addTwitterEventHandlers.bind(
                this
              )),
        ...
        (n.prototype.addWidgetListeners = function () {
          ...
          (n.prototype.handleFollowEvents = function (t) {
            if ("follow" == t.region) {
              var e =
                t.data.screen_name || t.target.getAttribute("data-screen-name");
      ...
      function (t, e, i) {
        ...
        e.exports = function (t, e, i) {
          function r() {
            ...
            e > d && d > 0
              ? (a = setTimeout(r, e - d))
              : ((a = null), i || ((u = t.apply(s, o)), a || (s = o = null)));
          }
          var a, o, s, l, u;
          return (
            null == e && (e = 100),
            function () {
              (s = this), (o = arguments), (l = n());
              var d = i && !a;
              return (
                a || (a = setTimeout(r, e)),
                d && ((u = t.apply(s, o)), (s = o = null)),
                u
              );
            }
          );
